...
urlpatterns = [
    ...
    path("view_feedbacks/", admins.view_feedbacks, name="view_feedbacks"),
    path("delete_feedback/<int:feedback_id>/", admins.delete_feedback, name="delete_feedback"),
    ...
    path("medical_chatbot/", usr.medical_chatbot, name="medical_chatbot"),
    path("nutrition_bot/", usr.nutrition_bot, name="nutrition_bot"),
    path("feedback/", usr.feedback_view, name="feedback"),
    path("insights/", usr.insights_dashboard, name="insights_dashboard"),
    path("delete_medical_history/<int:chat_id>/", usr.delete_medical_history, name="delete_medical_history"),
    path("delete_nutrition_history/<int:history_id>/", usr.delete_nutrition_history, name="delete_nutrition_history"),
